...
export const services: Array<{
  ...
  },
  {
    ...
    text: "Hilfe bei bestehenden Websites und Shops, Anpassungen, Weiterentwicklung, mobiler Ansicht und technischen Problemen.",
    icon: Wrench,
  },
  {
    ...
    text: "Realistische SEO-Grundlagen für neue und bestehende Websites, lokale Sichtbarkeit und saubere Indexierung.",
    icon: Search,
  },
  {
    ...
    href: "/preise",
    price: "Preis nach Absprache",
    text: "Größere Anpassungen, neue Unterseiten, Redesign, Relaunch-Unterstützung und Sonderfunktionen.",
    icon: Code,
  },
];
